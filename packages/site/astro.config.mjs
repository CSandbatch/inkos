...
export default defineConfig({
  ...
  integrations: [react(), starlight({
    ...
    sidebar: [
      ...
      { label: "Build", items: [{ label: "Build a fair mystery", slug: "docs/guides/mystery" }, { label: "Review, approve, and revise", slug: "docs/guides/review" }] },
      { label: "Reference", items: [{ label: "Studio API v1", slug: "docs/reference/api" }, { label: "Configuration", slug: "docs/reference/configuration" }] },
