...
export default defineConfig({
  ...
  integrations: [react(), starlight({
    ...
    sidebar: [
      { label: "Start", items: [{ label: "Project hub", slug: "docs/project-hub" }, { label: "Getting started", slug: "docs/getting-started" }, { label: "Sign in to a model provider", slug: "docs/guides/provider-sign-in" }] },
