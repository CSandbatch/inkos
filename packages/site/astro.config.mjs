...
export default defineConfig({
  ...
  integrations: [react(), starlight({
    ...
    sidebar: [
      ...
      { label: "Reference", items: [{ label: "Agent capabilities", slug: "docs/reference/agent-capabilities" }, { label: "Fair-play rules", slug: "docs/reference/fair-play-rules" }, { label: "Studio API v1", slug: "docs/reference/api" }, { label: "Configuration", slug: "docs/reference/configuration" }] },
